...
goal.save
milestone = Milestone.new(milestone_name: 'none', goal_id: goal.id, model_overview: 'none',
                          milestone_pic_url: 'https://i.imgur.com/ygSdPaS.png')
milestone.save
postthread = Postthread.new(thread_name: 'Shalalala', thread_status: 'To Start', milestone_id: milestone.id, thread_detail: 'Daga tries to woo Isana into hitting the sheets with him, after finding out about the necklace',
                            thread_link: 'none')
postthread.save
relation = Relationship.new(relation_name: 'Isana', relation_status: 'Mated', relation_detail: 'Been mated for a year',
                            character_id: character.id, relation_pic: 'https://i.imgur.com/AkGWRXS.png')
relation.save
